...
public class LlistaNoOrdenada<E> extends ListaRedundancias<E> {
    ...
    public void inserir(E e) {
        ...
        LlistaNode<E> newNode = new LlistaNode<E>(e);
    ...
    public int buscar(E e) throws ElementNoTrobat {
        ...
        if (primero.getdatoE().equals(e)) // ...el primero
            return 0;
        if (ultimo.getdatoE().equals(e)) // ...el ultimo
            return nElem - 1;
    ...
    private void buscarNodos(E e, int pos) {
        ...
        while (nodoBuscado != null && !encontrado) {
            ...
            if (nodoBuscado.getdatoE().equals(e) || posicion == pos)
                encontrado = true;
            else {
